...
typedef PyObject *(*symbolic_handler_callable)(Py_ssize_t n, PyObject *const *, PyObject *);
...
PyAPI_FUNC(SymbolicAdapter*) create_new_adapter(symbolic_handler_callable handler);
SymbolicAdapter *create_new_adapter_obj(PyObject *callable);

PyAPI_FUNC(PyObject*) SymbolicAdapter_run(PyObject *self, PyObject *function, PyObject *wrappers);
