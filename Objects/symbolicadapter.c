...
static PyObject *default_create_dict(void *arg, PyObject **keys, PyObject **elems) { Py_RETURN_NONE; }
static PyObject *default_create_dict_const_key(void *arg, PyObject *keys, PyObject **elems) { Py_RETURN_NONE; }
...
create_new_adapter_(PyObject *ready_wrapper_types, PyObject *global_symbolic_clones_dict, void *handler_param) {
    ...
    result->str_eq = default_binary;
    result->str_neq = default_binary;
    ...
    result->tp_call = default_unary_notify;
    result->tp_hash = default_unary_notify;
